...
python3 distillation/train.py \
	...
	--dump_path "zoo/$MODEL-10p-ce5-mlm2" \
	--data_file data/TBC-EnWiki-10percent.bert-base-uncased.pickle\
	--token_counts data/TBC-EnWiki-10percent-token_counts.bert-base-uncased.pickle --force
