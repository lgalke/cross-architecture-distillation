...
import sys
sys.path.insert(0, '.')
from seq2mat import Seq2matForMaskedLM, Seq2matTokenizer, Seq2matConfig
...
MODEL_CLASSES = {
    ...
    "seq2mat": (Seq2matConfig, Seq2matForMaskedLM, Seq2matTokenizer)
}
...
def sanity_checks(args):
    ...
    if args.mlm:
        ...
        assert (args.student_type in ["seq2mat", "roberta", "distilbert"]) and (args.teacher_type in ["roberta", "bert"])
    else:
        assert (args.student_type in ["seq2mat", "gpt2"]) and (args.teacher_type in ["gpt2"])

    assert args.teacher_type == args.student_type or (
        args.student_type == "distilbert" and args.teacher_type == "bert"
    ) or args.student_type == "seq2mat"
...
def main():
    ...
    parser.add_argument(
        "--student_type",
        type=str,
        choices=["distilbert", "roberta", "gpt2", "seq2mat"],
        required=True,
        help="The student type (DistilBERT, RoBERTa, Seq2mat).",
    )
